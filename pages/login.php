		...
		<div class="row">
			<div class="col-lg-6">
				<div class="login_box_img">
					<div class="hover">
						<h4>Еще не создали аккаунт у нас?</h4>
						<p>Для получения доступа к акциям и скидкам стоит это сделать прямо сейчас.</p>
	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Авторизация успешно завершена.</h5>
			</div>
			<div class="modal-body">И будете перенаправлены на страницу личного кабинета.</div>
		</div>
	</div>
</div>
<script>
